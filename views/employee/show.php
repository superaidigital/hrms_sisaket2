...
<div class="mb-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
    ...
    <div class="d-flex gap-2">
        <a href="index.php?action=edit&id=<?php echo $empData['id']; ?>" class="btn btn-outline-primary shadow-sm bg-white fw-bold">
            <i class="fa-solid fa-pen-to-square me-1"></i> แก้ไขประวัติ
        </a>
        <a href="index.php?action=print_kp7&id=<?php echo $empData['id']; ?>" class="btn text-white shadow-sm fw-bold" style="background-color: #0d9488;" target="_blank">
    ...
    <div class="col-md-4 col-lg-3">
        <div class="modern-card border-0 shadow-sm text-center p-4 sticky-top" style="top: 80px;">
            ...
            <p class="text-teal fw-semibold small mb-3" style="color: #0d9488;">
                ...
                <?php echo $currentLevel ? "($currentLevel)" : ""; ?>
            </p>
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format((float)$w['salary'], 2); ?></td>
                                ...
                                <table class="table custom-table table-hover border">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: foreach($act as $a): ?>
                                            <tr><td><?php echo htmlspecialchars($a['acting_position']); ?></td><td><?php echo htmlspecialchars($a['order_number']); ?></td><td><?php echo htmlspecialchars($a['start_date']); ?></td></tr>
                                ...
                                <table class="table custom-table table-hover border">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: foreach($ev as $e): ?>
                                            <tr><td><?php echo htmlspecialchars($e['eval_year']); ?></td><td><?php echo htmlspecialchars($e['eval_round']); ?></td><td><?php echo htmlspecialchars($e['score_percent']); ?>%</td><td><span class="badge bg-success"><?php echo htmlspecialchars($e['result_level']); ?></span></td></tr>
                                        <?php endforeach; endif; ?>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <tbody>
                                ...
                                <?php else: foreach($lv as $l): ?>
                                    <tr>
                                        ...
                                        <td class="text-danger"><?php echo htmlspecialchars($l['sick_leave']); ?></td>
                                        <td class="text-warning"><?php echo htmlspecialchars($l['personal_leave']); ?></td>
                                        <td class="text-success"><?php echo htmlspecialchars($l['vacation_leave']); ?></td>
                                        <td class="text-secondary"><?php echo htmlspecialchars($l['late_count']); ?></td>
                                    </tr>
                                <?php endforeach; endif; ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table custom-table table-hover border">
                            ...
                            <tbody>
                                ...
                                <?php else: foreach($dec as $d): ?>
                                    <tr><td><?php echo htmlspecialchars($d['decor_name']); ?></td><td><?php echo htmlspecialchars($d['received_year']); ?></td><td><?php echo htmlspecialchars($d['gazette_info']); ?></td></tr>
                                <?php endforeach; endif; ?>
                            </tbody>
                        </table>
                    </div>
                                ...
                                <table class="table custom-table table-hover border">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: foreach($lic as $l): ?>
                                            <tr><td><?php echo htmlspecialchars($l['license_name']); ?></td><td><?php echo htmlspecialchars($l['license_number']); ?></td><td><small class="text-muted"><?php echo htmlspecialchars($l['issue_date'] . ' - ' . $l['expiry_date']); ?></small></td></tr>
                                        <?php endforeach; endif; ?>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table class="table custom-table table-hover border border-danger border-opacity-25">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: foreach($dis as $d): ?>
                                            <tr><td><?php echo htmlspecialchars($d['incident_date']); ?></td><td class="text-danger fw-bold"><?php echo htmlspecialchars($d['punishment_type']); ?></td><td><?php echo htmlspecialchars($d['description']); ?></td></tr>
                                        <?php endforeach; endif; ?>
                                    </tbody>
                                </table>
                            </div>
